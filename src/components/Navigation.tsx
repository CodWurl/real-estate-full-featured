...
const Navigation = () => {
  ...
  return <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-pink">
      <div className="container mx-auto px-6 py-4 flex items-center justify-between border-black">
